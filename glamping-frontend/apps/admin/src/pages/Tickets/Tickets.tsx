...
const TYPE_CONFIG: Record<string, { icon: React.ReactNode; label: string }> = {
  ...
  kupe: { icon: <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M10 4 8 6"/><path d="M17 19v2"/><path d="M2 12h20"/><path d="M7 19v2"/><path d="M9 5 7.621 3.621A2.121 2.121 0 0 0 4 5v3"/><circle cx="12" cy="11" r="1"/><path d="M9 11h.01"/><path d="M14 11h.01"/><path d="M17 11h.01"/><path d="M17 5h.01"/><path d="M20 8a1 1 0 1 0 0-2 1 1 0 0 0 0 2"/></svg>, label: 'Купель' },
